...
public:
	...
	FUNCTION_HOOK_H(bool, allowIncomingPacketId, ServerNetworkHandler *, const RakNet::RakNetGUID &, int);

	FUNCTION_HOOK_H(void, handleLogin, ServerNetworkHandler *, const RakNet::RakNetGUID &, LoginPacket *);
	static void sendLoginMessageLocal(ServerNetworkHandler *real, const RakNet::RakNetGUID &, LoginPacket *, std::unique_ptr<ServerPlayer>);
